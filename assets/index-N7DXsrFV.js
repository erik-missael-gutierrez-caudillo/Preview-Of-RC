(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function a(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=a(i);fetch(i.href,l)}})();(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();tailwind.config={theme:{extend:{fontFamily:{serif:['"Playfair Display"',"serif"],sans:['"Inter"',"sans-serif"]},colors:{royal:{800:"#001b3d",900:"#001229"},gold:{100:"#FCF6BA",300:"#FBF5B7",400:"#BF953F",500:"#B38728",600:"#AA771C"},surface:"#f8fafc"},animation:{"fade-up":"fadeUp 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards",float:"float 6s ease-in-out infinite"},keyframes:{fadeUp:{"0%":{opacity:"0",transform:"translateY(20px)"},"100%":{opacity:"1",transform:"translateY(0)"}},float:{"0%, 100%":{transform:"translateY(0)"},"50%":{transform:"translateY(-10px)"}}}}}};const E="es-MX",d=e=>new Intl.NumberFormat(E).format(Number(e||0)),S=[{id:101,name:"Carpa Estructural 12x24m",img:"bx-building"},{id:102,name:"Carpa 6x18 Luxury",img:"bx-window"},{id:103,name:"Carpa 6x12 Luxury",img:"bx-building"},{id:104,name:"Carpa Eventos 4x8",img:"bx-store-alt"},{id:105,name:"Carpa Premium 4x4",img:"bx-building-house"},{id:106,name:"Sombrilla Gigante 3m",img:"bx-sun"},{id:201,name:"Silla Crossback",img:"bx-chair"},{id:202,name:"Mesa Parota (12px)",img:"bx-table"},{id:203,name:"Sala Lounge Velvet",img:"bx-sofa"},{id:204,name:"Mesa Parota (8px)",img:"bx-square"},{id:205,name:"Mesa Redonda (10px)",img:"bx-circle"},{id:206,name:"Mesa Rectangular (10px)",img:"bx-rectangle"},{id:207,name:"Mesa Tablón Pro",img:"bx-minus"},{id:208,name:"Silla Tiffany",img:"bx-chair"},{id:209,name:"Silla Plegable",img:"bx-chair"},{id:210,name:"Silla Phoenix",img:"bx-star"},{id:301,name:"Mantel Terciopelo",img:"bx-layer"},{id:302,name:"Servilleta Lino",img:"bx-bookmark"},{id:303,name:"Loza Vajilla Premium",img:"bx-restaurant"},{id:304,name:"Loza Vajilla Básica",img:"bx-restaurant"},{id:305,name:"Copa Vidrio",img:"bx-wine"},{id:306,name:"Copa Cristal",img:"bx-wine"},{id:307,name:"Cubiertos Gold",img:"bx-knife"},{id:308,name:"Cubiertos Silver",img:"bx-knife"},{id:309,name:"Mantelería Gold",img:"bx-layer"},{id:310,name:"Mantelería Básica",img:"bx-layer"},{id:401,name:"Pista Baile Charol",img:"bx-grid-alt"},{id:402,name:"Iluminación Arq.",img:"bx-bulb"},{id:403,name:"Calentador Ambiental",img:"bx-flame"},{id:404,name:"Hielera Grande",img:"bx-fridge"}],L=[{id:1,titulo:"Boda Imperial",categoria:"grand",pax:"150 personas",precio:18500,desc:"El lujo máximo. Carpa estructural gigante, pista de charol y vajilla gold.",items:[101,201,202,303,306,307,301,401,402]},{id:2,titulo:"Gala Corporativa",categoria:"grand",pax:"100 personas",precio:12800,desc:"Ideal para cenas de fin de año. Elegancia sobria con sillas Tiffany y mantelería fina.",items:[102,208,205,303,308,309,402]},{id:3,titulo:"Cóctel Sunset",categoria:"medium",pax:"60 personas",precio:6500,desc:"Ambiente relajado semi-cubierto con salas lounge y mesas altas.",items:[103,203,207,305,310,403,404]},{id:4,titulo:"Cena Toscana",categoria:"medium",pax:"50 personas",precio:7200,desc:"Estilo rústico elegante. Mesas de parota sin mantel y luces cálidas.",items:[103,201,202,306,307,302,402]},{id:5,titulo:"Petit Comité",categoria:"boutique",pax:"Menos de 30 personas",precio:3900,desc:"Exclusividad íntima. Sillas Phoenix transparentes y detalles premium.",items:[105,210,204,303,306,307,404]}];let n={filtroActual:"all",paquetesVisibles:[...L],indiceActual:0,intervaloAuto:null};const m=document.getElementById("slider-container"),x=document.getElementById("dots-container");function h(){w(),$(0,"init"),k()}function w(){x&&(x.innerHTML=n.paquetesVisibles.map((e,t)=>`
      <button aria-label="Ir al slide ${t+1}" onclick="clickPunto(${t})"
              class="group relative w-10 h-2 transition-all duration-500 rounded-full overflow-hidden">
          <div class="absolute inset-0 bg-white/20"></div>
          <div class="absolute inset-0 bg-gold-400 transition-transform duration-700 origin-left ${t===n.indiceActual?"scale-x-100":"scale-x-0"}"></div>
      </button>
  `).join(""))}function j(e){e!==n.indiceActual&&(n.indiceActual=e,$(e,"slide"),w(),A())}function $(e,t){const a=n.paquetesVisibles[e];if(!a||!m)return;const r=a.items.map(o=>{const s=S.find(u=>u.id===o);return s?`
          <li class="flex items-center gap-3 text-sm text-slate-200 group/item">
              ...
              <span class="font-light tracking-wide">${s.name}</span>
          </li>`:""}).join(""),i=`
  <div class="slide-content w-full min-h-full lg:h-[480px] flex flex-col lg:flex-row items-center justify-center lg:justify-between p-6 md:p-12 lg:p-16 gap-8 relative overflow-hidden bg-gradient-to-br from-[#0a192f] via-[#0d1b2a] to-[#0a192f]">
      ...
      <div class="w-full lg:w-1/2 text-white z-10 space-y-4 md:space-y-6">
          <div class="inline-flex items-center gap-2 px-3 py-1 bg-gold-400/10 border border-gold-400/50 rounded-full">
              ...
              <span class="text-[10px] font-black uppercase tracking-[0.2em] text-gold-400">Capacidad: ${a.pax} Personas</span>
          </div>

          <h3 class="text-3xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight tracking-tight">
              ${a.titulo.split(" ")[0]} <span class="text-gold-400 block lg:inline">${a.titulo.split(" ").slice(1).join(" ")}</span>
          </h3>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center gap-6 pt-4">
              <div class="flex flex-col">
                  ...
                  <div class="flex items-baseline gap-1">
                      <span class="text-3xl md:text-4xl font-bold text-white">$${d(a.precio)}</span>
                      <span class="text-xs text-slate-400 font-medium">MXN</span>
                  </div>
              </div>

              <button onclick="botReservePackage(${a.id})" 
    ...
    `}),e.innerHTML=r||'<p class="text-slate-500 text-sm text-center italic py-4">Carrito vacío</p>';const i=document.getElementById("total-display"),l=document.getElementById("item-count-label");i&&(i.innerText=`$${d(t)}`),l&&(l.innerText=`${a} ${a===1?"artículo seleccionado":"artículos seleccionados"}`)}let v=[{id:1,user:"Mariana Solis",text:"Mi evento fue un éxito gracias a sus recomendaciones. Se enfocaron en dejar más espacio sin importarles quitar algunas cosas ya pagadas, impecable servicio. Realmente superaron mis expectativas en cuanto a la logística.",rating:5,date:"Hace 2 días",reactions:{like:12,love:4,dislike:0},replies:[{id:900,user:"Rente Confort",isBrand:!0,text:"Gracias Mariana, fue un honor ser parte de tu día.",reactions:{like:2,love:1,dislike:0},replies:[]}]},{id:2,user:"Sebastian Estrada",text:"Es una excelente experiencia en su sitio. En sitios anteriores cada minuto me aparecían mensajes casi obligándome a realizar un pedido, aquí todo fluyó natural.",rating:5,date:"Hace 3 semanas",reactions:{like:8,love:0,dislike:0},replies:[{id:901,user:"Rente Confort",isBrand:!0,text:"Agradecemos mucho tu comentario Sebastian. Estamos a tus ordenes.",reactions:{like:1,love:0,dislike:0},replies:[]}]},{id:3,user:"Fernanda Lujan",text:"La decoración que realizaron en mi boda fue ¡Increíble! Muchas gracias por su muy buen servicio.",rating:5,date:"Hace 4 meses",reactions:{like:12,love:4,dislike:0},replies:[]},{id:4,user:"Pablo Santibañez",text:"Gran experiencia en todo momento, es la primera de muchas veces que realizaré un pedido con ustedes.",rating:4,date:"Hace 1 año",reactions:{like:2,love:1,dislike:0},replies:[]}],p;const N=1;function z(){const e=document.getElementById("reviews-container");e&&(e.innerHTML=v.map(t=>B(t)).join(""),setTimeout(()=>{v.forEach(t=>{const a=document.getElementById(`replies-container-${t.id}`);a&&a.classList.remove("open")})},50))}function B(e,t=!1){const a=e.rating?Array(e.rating).fill('<i class="bx bxs-star text-yellow-400 text-xs" aria-hidden="true"></i>').join(""):"",r=e.isBrand?'<span class="bg-blue-600 text-white text-[9px] px-1.5 py-0.5 rounded ml-1 font-bold uppercase tracking-wider" aria-hidden="true">Staff</span>':"",i=e.isBrand?"bg-royal-900 text-gold-400":"bg-gradient-to-br from-slate-200 to-slate-300 text-slate-600",l=e.isBrand?'<i class="bx bxs-crown" aria-hidden="true"></i>':e.user?e.user.charAt(0):"?";let o="",s="";return e.replies&&e.replies.length>0&&(s=`<button onclick="toggleReplies(${e.id})" class="text-xs font-semibold text-royal-600 hover:text-gold-500 ml-3 flex items-center gap-1" aria-expanded="false" aria-controls="replies-container-${e.id}"><i class='bx bx-subdirectory-right' aria-hidden="true"></i> Ver ${e.replies.length} respuesta(s)</button>`,o=`<div id="replies-container-${e.id}" class="nested-thread-container">${e.replies.map(u=>B(u,!0)).join("")}</div>`),t?`
      ...
      <div class="comment-card" role="article" aria-labelledby="comment-${e.id}">
        <div class="flex items-center justify-between mb-4 flex-shrink-0">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full ${i} flex items-center justify-center font-bold text-sm shadow-sm" aria-hidden="true">${l}</div>
            <div>
              <h4 id="comment-${e.id}" class="text-sm font-bold text-royal-900 leading-tight">${e.user} ${r}</h4>
              <div class="flex mt-0.5" aria-hidden="true">${a}</div>
            </div>
          </div>
        ...
        <div class="mt-auto border-t border-slate-100 pt-3 flex-shrink-0">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">${s}<button onclick="toggleReplyForm(${e.id})" class="text-slate-400 hover:text-royal-600 text-lg ml-3 p-1 transition" title="Responder"><i class='bx bx-message-rounded-add' aria-hidden="true"></i></button></div>
          </div>
      ...
      </div>`}function y(e,t,a,r){return`<button onclick="react(${e}, '${t}', this)" class="reaction-btn flex items-center gap-1 text-slate-400 group" aria-pressed="false" aria-label="${t}"><i class='bx ${r} group-hover:scale-110 transition-transform' aria-hidden="true"></i><span class="text-xs font-medium">${a}</span></button>`}function V(){p&&clearInterval(p),p=setInterval(()=>{{const e=document.getElementById("reviews-container");e&&(e.scrollLeft+=N)}},30)}document.addEventListener("DOMContentLoaded",()=>{z(),V(),q(),h(),M(),Object.keys(c).length>0});
